...
3. `_strategy/블로그자동화방_전용규약.md` — **이 방 규약**
...
## 이 방 정본 문서
- `knowledge/규격_차노_블로그_작성법_정본.md`
- `scripts/naver_blog_save.mjs`
...
{"room": "블로그자동화방", "task": "실행할 명령 또는 지시", "timeout": 30}
```
디스패처가 5초마다 물어간다. ⚠️ `status: done` 은 증거가 아니다 — 산출 파일·로그·permalink 중 하나를 **실측**하고 보고한다.

---
*정본: `_ROOMS.md` · 규약: `_strategy/블로그자동화방_전용규약.md`*
