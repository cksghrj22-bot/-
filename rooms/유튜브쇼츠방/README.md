...
3. `_strategy/유튜브쇼츠방_전용규약.md` — **이 방 규약**
...
## 이 방 정본 문서
- `pipeline/보완게이트_정본_2026-08-14.md`
- `knowledge/규격_일기형쇼츠_정본.md`
- `scripts/shorts_gate.py`
...
{"room": "유튜브쇼츠방", "task": "실행할 명령 또는 지시", "timeout": 30}
```
디스패처가 5초마다 물어간다. ⚠️ `status: done` 은 증거가 아니다 — 산출 파일·로그·permalink 중 하나를 **실측**하고 보고한다.

---
*정본: `_ROOMS.md` · 규약: `_strategy/유튜브쇼츠방_전용규약.md`*
