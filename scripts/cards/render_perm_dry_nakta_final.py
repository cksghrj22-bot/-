#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Render final 4-card perm/dry nakta carousel."""
...
SLIDES = [
    ...
    Slide(
        4,
        MAGIC / "IMG_8221 4.MOV",
        (
            ("설정", "펌을 드라이와 같이는 못해도,"),
            ("결론", "지금보다 나은 — 손질 되는 머리로"),
            ("시안", "보답드릴게요"),
        ),
        4.0,
        4.8,
